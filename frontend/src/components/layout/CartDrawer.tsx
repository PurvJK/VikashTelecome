                ...
                items.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-primary font-semibold mt-1">₹{(item.variant?.price ?? item.product.price).toLocaleString()}</p>
            ...
            {items.length > 0 && (
              <div className="p-5 border-t border-border space-y-4">
                ...
                <button
                  ...
                  className="w-full py-3.5 bg-primary text-primary-foreground font-semibold rounded-xl hover:bg-primary-hover transition-colors"
                >
                  Checkout
                </button>
              </div>
