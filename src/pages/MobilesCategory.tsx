...
const MobilesCategory = () => {
  ...
  const filteredProducts = useMemo(() => {
    let result: MobileProduct[] = [...mobileProducts];
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container-main py-6">
        ...
        <div className="flex gap-8">
          <MobileFilterSidebar filters={filters} onChange={handleFilterChange} onReset={handleReset} />
          <AnimatePresence>
            {showMobileFilters && (
              <MobileFilterSidebar filters={filters} onChange={handleFilterChange} onReset={handleReset} isMobile onClose={() => setShowMobileFilters(false)} />
            )}
          </AnimatePresence>
