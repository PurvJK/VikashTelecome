...
import { mobileBrands, ramOptions, storageOptions } from "@/data/mobileProducts";
...
export const MobileFilterSidebar = ({ filters, onChange, onReset, isMobile, onClose }: MobileFilterSidebarProps) => {
