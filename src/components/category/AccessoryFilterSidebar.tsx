...
import { accessoryBrands, accessoryTypes, compatibilityOptions } from "@/data/mobileAccessoriesProducts";
...
export const AccessoryFilterSidebar = ({ filters, onChange, onReset, isMobile, onClose }: AccessoryFilterSidebarProps) => {
